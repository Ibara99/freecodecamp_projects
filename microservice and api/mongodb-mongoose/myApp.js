...
//connect mariadb
var db_cache = mongoose.connect(process.env.MONGO_URI, { useNewUrlParser: true, useUnifiedTopology: true });
...
var createAndSavePerson = function(done) {
  let dave = new Person({name : "Dave", age: 27, favoriteFoods: ["anu", "ampas"]})
	dave.save((err, data) => {
...
var findEditThenSave = function(personId, done) {
  ...
  // cara begini bisa harusnya
  // Person.update({personId}, {favoriteFood: foodToAdd}, (err, data)=>{
  //   if (err) console.log(err);
  //   console.log(data);
  //   return done(null, data);
  // })
